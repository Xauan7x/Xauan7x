...
api_key = '6665816565:AAEHxXS0eNG7xaxU7ozrItpt4-wHilZ5H9s6665816565:AAEHxXS0eNG7xaxU7ozrItpt4-wHilZ5H9s'  # Substitua pelo seu próprio token
chat_id = '-1002022301496'  # Substitua pelo ID do seu canal
                                                                                            ...
                                                                                            random.shuffle(minas)
                                                                                                ...
                                                                                                def button_link():
                                                                                                    markup = InlineKeyboardMarkup()
                                                                                                        markup.row_width = 2
                                                                                                            markup.add(InlineKeyboardButton(text="📲 Cadastre-se Agora", url="https://nn55.co/home/game?id=49246501&gameCategoryId=0"))
                                                                                                                return markup
